...
fn resolve_predefined_charsets_id() {
    assert_eq!(
        Some(2),
        Charsets::Predefined(PredefinedCharsets::ISOAdobe).resolve_sid(2)
    );
    assert_eq!(
        None,
        Charsets::Predefined(PredefinedCharsets::ISOAdobe).resolve_sid(229)
    );

    assert_eq!(
        Some(229),
        Charsets::Predefined(PredefinedCharsets::Expert).resolve_sid(2)
    );
    assert_eq!(
        None,
        Charsets::Predefined(PredefinedCharsets::Expert).resolve_sid(230)
    );
